...
st.write(
    "For information on how to get Yandex oAuth credentials or how to create the oAuth client, you can visit the official Jira documentation: https://yandex.ru/dev/id/doc/en/index.html"
)
