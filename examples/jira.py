...
st.write(
    "For information on how to get Jira oAuth credentials or how to create the oAuth client, you can visit the official Jira documentation: https://developer.atlassian.com/cloud/jira/platform/oauth-2-3lo-apps/"
)
