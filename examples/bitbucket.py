...
st.write(
    "For information on how to get Bitbucket oAuth credentials or how to create the oAuth client, you can visit the official Bitbucket documentation: https://developer.atlassian.com/cloud/bitbucket/oauth-2/"
)
